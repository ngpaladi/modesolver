...
- [API Reference](https://yourusername.github.io/photonic-mode-solver/)
- [Sphinx Documentation](docs/index.html)

Documentation is automatically generated using Sphinx and hosted via GitHub Pages.